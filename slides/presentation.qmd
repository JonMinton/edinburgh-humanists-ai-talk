...
<!-- TODO: source a real protein-structure figure (DeepMind / Nature, with proper attribution) if a visual is wanted here. -->
...
So: AI is older than ChatGPT, stranger than ChatGPT, and — in the hands of its quieter builders — considerably more interesting.
...
## A bridge between cloth and wire {.smaller}

:::: {.columns}
::: {.column width="40%"}
![](images/blog/images_large_fg1.jpeg){width=95%}
:::
::: {.column width="60%"}
...
## Chain-of-thought and Agentic AI {.smaller}
...
This involves prompting AI chatbots to 'talk to themselves'. A process known as **chain-of-thought (CoT)**.
...
1) Know the market value of items in the collection. (If my mother decides to sell some of it, what to try selling first.)

2) Know more about my father's interests and preoccupations. I know he liked Sci-Fi a lot, but it would be good to know what kinds of books he had on different kinds of Sci-Fi scenarios (for example).
...
## How AI looks from the outside {.smaller}

![](images/trash-icon-evolution.png){width=72%}
...
## The valley of death {.center}

![](images/valley_of_death.png){.r-stretch fig-align="center"}

---

## The valley of death — what it traps {.smaller}
...
## Why the Industrial Revolution took a century {.smaller}

The marginal benefit of a *new* technology to an *old* factory was often low or even negative.

Only if the factory was built **from scratch** around the new tech did the main benefits **accrue**.

But this requires entirely new mindsets, ideas about work, and skills.


---

## Being a computer, then having one {.smaller}
...
![](images/kaldor_hicks.png){width=70%}
...
- **Hype-vs-capability curve**: Jon Minton, [jonminton.github.io/jon-blog](https://jonminton.github.io/jon-blog/).
- **Valley of death**, **Kaldor-Hicks**, and the **two traditions** schematic: Jon Minton's own work for this talk and earlier writing.

<!--
  Orphaned credits removed (images no longer in the deck):
    - Downing Street meeting (Simon Walker / No 10, CC BY 2.0).
    - Elon Musk 2018 (Debbie Rowe via Duncan.Hull, CC BY-SA 4.0).
  Restore here if those slides return.

  Verify before public sharing:
    - Exact provenance/licence of the Hassabis press photo.
    - Exact source paper for the Harlow rhesus-monkey figure (file is images_large_fg1.jpeg).
-->
