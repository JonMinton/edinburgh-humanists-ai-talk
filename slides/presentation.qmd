...
## Why the Industrial Revolution took around a century {.smaller}
...
- **AlphaFold predicted structure**: from the published AlphaFold literature (DeepMind; Jumper et al., *Nature*, 2021); reproduced for educational discussion.
...
<!--
  ...
  Verify before public sharing:
    ...
    - Exact source/citation for the AlphaFold figure (file is images_large_fg1.jpeg, suggestive of a journal CDN path).
-->
